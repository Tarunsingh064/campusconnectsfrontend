...
const PostsFeed = () => {
  ...
  const PostCard = ({ post }) => {
    ...
    return (
      <motion.div
        ...
        className="bg-gray-900 rounded-lg border border-gray-700 overflow-hidden w-full max-w-2xl mx-auto mb-6"
      >
        {/* Post Header */}
        <div className="flex items-center justify-between p-3 border-b border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-semibold text-white text-sm">{post.owner_username}</h2>
            </div>
          </div>
          {isOwner && (
            <div className="relative group">
              ...
              <div className="absolute right-0 mt-1 w-32 bg-gray-800 rounded-md shadow-lg py-1 z-10 hidden group-hover:block border border-gray-700">
                <button
                  onClick={handleEditClick}
                  className="block w-full text-left px-4 py-2 text-sm text-purple-400 hover:text-white hover:bg-gray-700 transition"
                >
                  Edit
                </button>
                <button
                  onClick={handleDeleteClick}
                  className="block w-full text-left px-4 py-2 text-sm text-red-500 hover:text-red-400 hover:bg-gray-700 transition"
                >
                  Delete
                </button>
              </div>
        ...
        <div className="p-3">
          <div className="flex justify-between items-center mb-2">
            <div className="flex gap-4">
              ...
              <button className="focus:outline-none">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7 text-white">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186c.18.324.283.696.283 1.093s-.103.770-.283 1.093m0-2.186l9.566-5.314m-9.566 7.5l9.566 5.314m0 0a2.25 2.25 0 103.935 2.186 2.25 2.25 0 00-3.935-2.186zm0-12.814a2.25 2.25 0 103.933-2.185 2.25 2.25 0 00-3.933 2.185z" />
                </svg>
              </button>
            </div>
            <button className="focus:outline-none">
          ...
          {likeCount > 0 && (
            <div className="mb-1">
              <p className="text-sm font-semibold text-white">{likeCount} {likeCount === 1 ? 'like' : 'likes'}</p>
            </div>
          )}
            ...
            <div className="mt-3 border-t border-gray-700 pt-3">
              <form onSubmit={handleCommentSubmit} className="flex gap-2 mb-3">
                <input
                  ...
                  className="flex-1 text-sm bg-gray-800 text-white border-none rounded-full px-3 py-2 focus:ring-0 focus:outline-none"
                />
                <button 
                  type="submit"
                  disabled={!commentText.trim()}
                  className={`text-sm font-semibold ${!commentText.trim() ? 'text-blue-400' : 'text-blue-500'}`}
                >
                  Post
                </button>
              </form>
          ...
          <div className="border-t border-gray-700 p-3">
            <form onSubmit={handleCommentSubmit} className="flex items-center">
              ...
              <button 
                type="submit"
                disabled={!commentText.trim()}
                className={`text-sm font-semibold ml-2 ${!commentText.trim() ? 'text-blue-400' : 'text-blue-500'}`}
              >
                Post
              </button>
            </form>
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-950">
      {/* Fixed Header */}
      <div className="sticky top-0 z-20 bg-gray-900 border-b border-gray-800 p-4 flex items-center justify-between">
      ...
      {showCreate && (
        <motion.div
          ...
          className="sticky z-10 bg-gray-900 border-b border-gray-800 shadow-sm"
        >
          <div className="p-4">
            <textarea
              value={text}
              ...
              className="w-full p-3 rounded border border-gray-700 bg-gray-800 text-white placeholder-gray-400 resize-none focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
              rows="3"
            />
            <div className="flex justify-between items-center mt-3">
              <div className="flex items-center">
                ...
                <label
                  ...
                  className="p-2 rounded-full hover:bg-gray-800 transition cursor-pointer text-white"
                  title="Add media"
                >
              ...
              <button
                ...
                className={`px-4 py-2 rounded font-medium ${(!text.trim() && !media) || loading ? 'bg-purple-800 cursor-not-allowed' : 'bg-purple-600 hover:bg-purple-700'} text-white transition`}
              >
